...
## This Method suggests either 3 or 4 clusters. 

#   * Why does this method work? What's the intuition behind it?
##  There is adrop in within groups sum of squares in the first 3 clusters. After 3 clusters, this decrease drops off.
...
## This method suggest 3 clusters as well.
